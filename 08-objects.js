// Objects are defined by their properties and functions
// Properties define what the thing is
// Functions define what the thing does
// how to create an object in JS
// how to compare two objects JS
...
let wheelProperties = [isRound, width, numberOfSpokes, material];
console.log(wheelProperties);

let wheel1 = {
    // property name (key): property value
    isRound: true, width: 10, numberOfSpokes: 5, material: "Rubber"
};
console.log(wheel1);

let wheel2 = {
    isRound: true, width: 12, numberOfSpokes: 4, material: "Rubber"
};
console.log(wheel2);
...
console.log(wheel1.pressure); // dot notation

console.log(wheel2["numberOfSpokes"]); // square bracket notation

// [i] for index variable
// can be used for linking to an array for an imagelnk or even a name
...
let show = {
  ...
  let season2Episode2Name = show.seasonInfo.episodeInfo[1].episodeName;
